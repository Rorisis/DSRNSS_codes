...
We also provide pretrained models, which can be downloaded from the link [here](https://github.com/Rorisis/DSRNSS_codes/releases/tag/ckpts). To evaluate them, simply provide them as the argument `--ckpt_path`.
